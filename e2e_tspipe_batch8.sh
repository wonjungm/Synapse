...
export RUN_NOTE_BASE="${RUN_NOTE_BASE:-e2e_tspipe_batch8_30_80}"
export RUN_NOTE="${RUN_NOTE:-${RUN_NOTE_BASE}_$(date +%Y%m%d_%H%M%S)}"
export SLOWDOWN_GPU="${SLOWDOWN_GPU:-0}"
export MAX_STEPS_PER_EPOCH=0
export TOTAL_STEPS="${TOTAL_STEPS:-15836}"
export SLOWDOWN_START_PCT="${SLOWDOWN_START_PCT:-30}"
export SLOWDOWN_END_PCT="${SLOWDOWN_END_PCT:-80}"
...
export SLOWDOWN_FIXED_MS="${SLOWDOWN_FIXED_MS:-700}"
